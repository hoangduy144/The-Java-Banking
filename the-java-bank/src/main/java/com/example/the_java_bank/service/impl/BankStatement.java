...
public class BankStatement {
    ...
    private static final String FILE = "E:\\Project Java\\Banking_Statement.pdf";
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("The Java Banking"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.CYAN);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("QUAN 10 - TPHCM"));
